...
- [[#magit][MAGIT]]
- [[#templates][TEMPLATES]]
- [[#templates-and-eglot][TEMPLATES AND EGLOT]]
- [[#treemacs][TREEMACS]]
- [[#themes][THEMES]]
...
- [[#org-latex][ORG LATEX]]
- [[#org-babel][ORG BABEL]]
  - [[#setup-common-lisp][Setup Common Lisp]]
...
#+begin_src emacs-lisp
    (use-package dashboard
      ...
      (setq dashboard-banner-logo-title "Prami fa mi do")
...
#+begin_src emacs-lisp
  (use-package citar
    :ghook ('org-mode-hook 'citar-capf-setup)
    :custom
    (citar-bibliography '("~/bib/references.bib"))
    (org-cite-global-bibliography '("~/bib/references.bib"))
    (org-cite-processor-insert 'citar)
    (org-cite-processor-follow 'citar)
    (org-cite-processor-activate 'citar))
...
First of all, we configure Eglot generally
...
Keep an eye on cider-storm, it didn't work for me last time using ClojureStorm
#+begin_src emacs-lisp
  (use-package cider
    :config
  ...
  (use-package clj-refactor
    :ghook ('clojure-mode-hook (lambda ()
                                   (clj-refactor-mode 1)
                                   (cljr-add-keybindings-with-prefix "C-c r"))))
  ;; ===

  (use-package cider-hydra
    :ghook ('clojure-mode-hook #'cider-hydra-mode))
  ...
  (use-package eglot
    ...
    :config
        (add-to-list 'eglot-server-programs
                     `(csharp-mode . ("/usr/bin/OmniSharp" "-lsp")))
              (add-to-list 'eglot-server-programs
                           `(csharp-tree-sitter-mode . ("/home/giancarlo/Vídeos/OmniSharp" "-lsp"))))
  #+end_src
** Java
#+begin_src emacs-lisp
  (use-package eglot
    :elpaca nil
    :ghook ('java-mode-hook 'eglot-ensure)
    :init
    (add-to-list 'eglot-server-programs
                 '(java-mode . ("~/.config/emacs/share/eclipse.jdt.ls/bin/jdtls"))))
...
#+begin_src emacs-lisp
  ...
  (use-package eglot
    :elpaca nil
    :ghook ('haskell-mode-hook 'eglot-ensure)
    :init
    (add-to-list 'eglot-server-programs
